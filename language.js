(function () {
  ...
  const pages = {
    ...
    "future-fashion.html": [
      ...
      [".fashion-project-definition .fashion-research-copy p:nth-child(1)", "Fashion After Fabric is Parallel Vision’s material research archive: a study of garments beyond conventional fabric, where responsive matter, synthetic surfaces and body systems begin to replace textiles.", "Fashion After Fabric ist das Materialforschungsarchiv von Parallel Vision: eine Untersuchung von Kleidung jenseits konventioneller Stoffe, in der reaktive Materie, synthetische Oberflächen und Körpersysteme beginnen, Textilien zu ersetzen."],
      [".fashion-project-definition .fashion-research-copy p:nth-child(2)", "Across images, moving works, artist collaborations and physical experiments, clothing becomes something closer to an environment around the body.", "Über Bilder, Bewegtbildarbeiten, künstlerische Kollaborationen und physische Experimente hinweg wird Kleidung zu etwas, das eher einer Umgebung um den Körper gleicht."],
