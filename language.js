(function () {
  ...
  const home = [
    ...
    ["#nina-fok .nina-identity-discover", "Discover the project", "Projekt entdecken"],
    ["#releases > .wrapper > .section-head h2", "Releases", "Veröffentlichungen"],
    ...
    ["#listening-title", "Listen", "Hören"],
    [".listening-heading p", "Selected by Alejandro Molinari", "Ausgewählt von Alejandro Molinari"],
    [".listening-open", "Listen", "Hören"],
    [".listening-close", "Close", "Schließen"],
  ...
  const pages = {
    ...
    "berlin-2063.html": [
      ...
      [".berlin-hero-portals a[href='#world-urbanForm'] b", "The City", "Die Stadt"],
      [".berlin-hero-portals a[href='#world-urbanSystems'] b", "Urban Systems", "Urbane Systeme"],
      [".berlin-hero-portals a[href='#inhabitants-entry'] b", "Its Inhabitants", "Die Bewohner:innen"],
      [".berlin-hero-portals a[href='#world-nightlife'] b", "After Dark", "Nach Einbruch der Dunkelheit"],
      [".berlin-hero-portals a[href='#world-transmissions'] b", "Transmissions", "Übertragungen"],
      [".berlin-hero-portals a[href='#world-materialCulture'] b", "Fashion After Fabric", "Fashion After Fabric"],
      [".berlin-hero-label", "Parallel Vision / Living Archive", "Parallel Vision / Lebendiges Archiv"],
      [".berlin-hero-line", "A visual archive of Berlin, 2063 and beyond.", "Ein visuelles Archiv von Berlin, 2063 und darüber hinaus."],
    ...
    "future-fashion.html": [
      ...
      [".fashion-project-definition .fashion-research-copy p:nth-child(1)", "Fashion After Fabric explores clothing as an environment for the body. In Parallel Vision’s Berlin 2063, the city transforms to protect its inhabitants. Here, that same idea takes shape in garments conceived to adapt to the body and the world around it.", "Fashion After Fabric erforscht Kleidung als Umgebung für den Körper. In Parallel Visions Berlin 2063 verwandelt sich die Stadt, um ihre Bewohner:innen zu schützen. Dieselbe Idee nimmt hier in Kleidungsentwürfen Gestalt an, die sich dem Körper und seiner Umwelt anpassen sollen."],
      ...
      [".fashion-collaboration .fashion-chapter-copy p:nth-child(2)", "Artists inhabit Berlin 2063 through films and projected runways, each wearing a study in how clothing could behave, protect and transform.", "In Filmen und projizierten Laufstegen bewohnen Künstler:innen Berlin 2063. Jeder ihrer Looks untersucht, wie Kleidung sich verhalten, schützen und verwandeln könnte."],
