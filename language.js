(function () {
  ...
  const home = [
    ...
    ["#artists .artists-intro-copy", "A growing constellation of artists, performers and artificial identities shaping the sound and visual language of Parallel Vision.", "Eine wachsende Konstellation aus Künstler:innen, Performer:innen und künstlichen Identitäten, die die klangliche und visuelle Sprache von Parallel Vision prägen."],
    ["#artists .artist-card-alejandro .artist-card-city", "Berlin", "Berlin"],
    ["#artists .artist-card-alejandro .artist-card-description", "Founder, producer and live performer building the central sound of Parallel Vision.", "Gründer, Produzent und Live-Performer, der den zentralen Klang von Parallel Vision formt."],
    ["#artists .artist-card-refrakt .artist-card-city", "New York", "New York"],
    ["#artists .artist-card-refrakt .artist-card-description", "Dark club pressure, cinematic tension and transatlantic electronics.", "Dunkler Clubdruck, filmische Spannung und transatlantische Elektronik."],
    ["#artists .artist-card-refrakt .artist-card-action", "View artist", "Artist ansehen"],
    ["#artists .artist-card-elorian .artist-card-city", "Mexico City", "Mexiko-Stadt"],
    ["#artists .artist-card-elorian .artist-card-description", "Hypnotic movement, synthetic atmosphere and emotional rhythm.", "Hypnotische Bewegung, synthetische Atmosphäre und emotionaler Rhythmus."],
    ["#artists .artists-secondary-label", "Associated artists / Archive", "Assoziierte Künstler:innen / Archiv"],
  ...
  const pages = {
    ...
    "future-fashion.html": [
      ...
      ["#fashion-organism-title", "From Garment to Organism", "Vom Kleidungsstück zum Organismus"],
      [".fashion-organism .fashion-chapter-copy p:nth-child(1)", "In the world of Berlin 2063, clothing is no longer an external layer.", "In der Welt von Berlin 2063 ist Kleidung keine äußere Schicht mehr."],
      [".fashion-organism .fashion-chapter-copy p:nth-child(2)", "Liquid-metal alloys respond to movement, temperature and bioelectric activity. Synthetic membranes merge with the body. Materials adapt, protect, record and transform.", "Flüssigmetalllegierungen reagieren auf Bewegung, Temperatur und bioelektrische Aktivität. Synthetische Membranen verschmelzen mit dem Körper. Materialien passen sich an, schützen, speichern und transformieren."],
      [".fashion-organism .fashion-chapter-copy p:nth-child(3)", "The garment becomes a second dermal system: part clothing, part technology, part living structure.", "Das Kleidungsstück wird zu einem zweiten dermalen System: teils Kleidung, teils Technologie, teils lebende Struktur."],
