(function () {
  ...
  const pages = {
    ...
    "berlin-2063.html": [
      ...
      [".berlin-hero-portals a[href='#world-urbanForm'] b", "Urban Form", "Urbane Form"],
      [".berlin-hero-portals a[href='#world-urbanSystems'] b", "Urban Systems", "Urbane Systeme"],
      [".berlin-hero-portals a[href='#inhabitants-entry'] b", "Inhabitants", "Bewohner:innen"],
      [".berlin-hero-portals a[href='#world-nightlife'] b", "Nightlife", "Nachtleben"],
      [".berlin-hero-portals a[href='#world-transmissions'] b", "Transmissions", "Übertragungen"],
      [".berlin-hero-portals a[href='#world-materialCulture'] b", "Material Culture", "Materielle Kultur"],
