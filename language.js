(function () {
  ...
  const home = [
    ...
    ["#berlin .berlin-entry-line:nth-child(1)", "Berlin 2063 is an evolving archive exploring how emerging materials, technologies and cultural systems may transform everyday life.", "Berlin 2063 ist ein wachsendes Archiv, das untersucht, wie neue Materialien, Technologien und kulturelle Systeme den Alltag verändern könnten."],
    ["#berlin .berlin-entry-line:nth-child(2)", "Through imagined environments, inhabitants, garments, sound and personal histories, the project examines how changes already taking shape today could reshape bodies, cities, identity and collective memory.", "Anhand imaginierter Umgebungen, Bewohner:innen, Kleidungsstücke, Klänge und persönlicher Geschichten untersucht das Projekt, wie bereits heute entstehende Veränderungen Körper, Städte, Identität und kollektive Erinnerung neu formen könnten."],
    ["#berlin .berlin-entry-line:nth-child(3)", "The archive grows through films, music, fashion research, installations and evolving digital environments. Over time, audiences will be able to enter and explore Berlin 2063 through immersive experiences, virtual spaces and encounters with its inhabitants.", "Das Archiv wächst durch Filme, Musik, Modeforschung, Installationen und sich entwickelnde digitale Umgebungen. Mit der Zeit wird das Publikum Berlin 2063 durch immersive Erfahrungen, virtuelle Räume und Begegnungen mit seinen Bewohner:innen betreten und erkunden können."],
  ...
  const pages = {
    ...
    "future-fashion.html": [
      ...
      [".fashion-manifesto-questions h2:nth-child(1)", "What happens when clothing no longer follows the body, but begins responding to it?", "Was geschieht, wenn Kleidung dem Körper nicht länger folgt, sondern beginnt, auf ihn zu reagieren?"],
      [".fashion-manifesto-questions h2:nth-child(2)", "What happens when the boundary between body and garment begins to disappear?", "Was geschieht, wenn die Grenze zwischen Körper und Kleidungsstück zu verschwinden beginnt?"],
      [".fashion-manifesto-questions h2:nth-child(3)", "When clothing can alter the body, does it still express who we are, or does it begin to determine who we become?", "Wenn Kleidung den Körper verändern kann, drückt sie dann noch aus, wer wir sind, oder beginnt sie zu bestimmen, wer wir werden?"],
      [".fashion-manifesto-support p:nth-child(1)", "Fashion After Fabric investigates these questions through material research, developing garments that no longer behave as passive objects but as responsive systems capable of interacting with the body.", "Fashion After Fabric untersucht diese Fragen durch Materialforschung und entwickelt Kleidungsstücke, die sich nicht länger wie passive Objekte verhalten, sondern wie reaktive Systeme, die mit dem Körper interagieren können."],
      [".fashion-manifesto-support p:nth-child(2)", "Each collection proposes a different material hypothesis, exploring how new relationships between body and matter could reshape the future of clothing.", "Jede Kollektion formuliert eine andere Materialhypothese und untersucht, wie neue Beziehungen zwischen Körper und Materie die Zukunft der Kleidung neu gestalten könnten."],
      ...
      [".fashion-project-definition .fashion-chapter-copy p:nth-child(1)", "Fashion After Fabric explores what clothing becomes when textiles are replaced by responsive, biological and synthetic systems.", "Fashion After Fabric untersucht, was aus Kleidung wird, wenn Textilien durch reaktive, biologische und synthetische Systeme ersetzt werden."],
      [".fashion-project-definition .fashion-chapter-copy p:nth-child(2)", "Each collection develops a distinct material hypothesis—from liquid metal and programmable surfaces to engineered tissue, magnetic structures and living membranes.", "Jede Kollektion entwickelt eine eigene Materialhypothese – von Flüssigmetall und programmierbaren Oberflächen bis zu künstlich erzeugtem Gewebe, magnetischen Strukturen und lebenden Membranen."],
      [".fashion-project-definition .fashion-chapter-copy p:nth-child(3)", "Together, they form an evolving archive of possible relationships between clothing, technology and the human body.", "Gemeinsam bilden sie ein wachsendes Archiv möglicher Beziehungen zwischen Kleidung, Technologie und dem menschlichen Körper."],
      ...
      [".fashion-material-archive .fashion-chapter-label", "05 Collections", "05 Kollektionen"],
      ["#fashion-archive-title", "Fashion Archive", "Modearchiv"],
      ...
      [".preview-card[href='./chromia.html'] p", "A bio-reactive liquid-metal alloy developing into a second dermal structure.", "Eine bioreaktive Flüssigmetalllegierung, die sich zu einer zweiten dermalen Struktur entwickelt."],
      [".preview-card[href='./flesh-zero.html'] p", "Synthetic tissue and engineered surfaces forming a new external anatomy.", "Synthetisches Gewebe und technisch erzeugte Oberflächen bilden eine neue äußere Anatomie."],
      [".preview-card[href='./lotus-2063.html'] p", "Protective volume, architecture and social presence within future nightlife.", "Schützendes Volumen, Architektur und soziale Präsenz im zukünftigen Nachtleben."],
      [".preview-card[href='./magnetic-tape.html'] p", "Memory embedded in matter and past images of the future.", "In Materie eingebettete Erinnerung und vergangene Bilder der Zukunft."],
      [".preview-card[href='./dna-mutation.html'] p", "Biological adaptation and mutation functioning as the garment.", "Biologische Anpassung und Mutation, die als Kleidungsstück fungiert."],
      ...
      [".fashion-project-relationships div:nth-child(1) p", "The creative and research platform connecting music, material research and evolving cultural worlds.", "Die Kreativ- und Forschungsplattform, die Musik, Materialforschung und sich entwickelnde kulturelle Welten verbindet."],
      [".fashion-project-relationships div:nth-child(2) p", "The material research project exploring changing relationships between clothing, matter and the human body.", "Das Materialforschungsprojekt, das die sich verändernden Beziehungen zwischen Kleidung, Materie und dem menschlichen Körper untersucht."],
      [".fashion-project-relationships div:nth-child(3) p", "The evolving archive documenting how these transformations reshape culture and everyday life.", "Das wachsende Archiv, das dokumentiert, wie diese Transformationen Kultur und Alltag neu gestalten."],
    ...
    "chromia.html": [
      [".collection-intro p", "Chromia investigates a bio-reactive liquid-metal alloy that merges with the wearer and develops into a second dermal structure.\n\nThe material responds to movement, biological information and continuous contact with the body. Its final form emerges through the relationship between alloy and host.", "Chromia untersucht eine bioreaktive Flüssigmetalllegierung, die mit der tragenden Person verschmilzt und sich zu einer zweiten dermalen Struktur entwickelt.\n\nDas Material reagiert auf Bewegung, biologische Informationen und den kontinuierlichen Kontakt mit dem Körper. Seine endgültige Form entsteht durch die Beziehung zwischen Legierung und Wirt."],
      [".archive-footer a", "Next: Flesh Zero →", "Weiter: Flesh Zero →"]
    ],
    "flesh-zero.html": [
      [".collection-intro p", "Flesh Zero explores the threshold between clothing and synthetic tissue.\n\nGas, foam, mineral structures, volatile matter and engineered surfaces form a new external anatomy around the body.", "Flesh Zero erforscht die Schwelle zwischen Kleidung und synthetischem Gewebe.\n\nGas, Schaum, mineralische Strukturen, flüchtige Materie und technisch erzeugte Oberflächen bilden eine neue äußere Anatomie um den Körper."],
      [".archive-footer a", "Next: Lotus 2063 →", "Weiter: Lotus 2063 →"]
    ],
    "lotus-2063.html": [
      [".collection-intro p", "Lotus 2063 explores clothing as protective volume, architecture and social presence within future nightlife.\n\nIts silhouettes construct shifting spaces around the body, shaping movement, distance and visibility.", "Lotus 2063 erforscht Kleidung als schützendes Volumen, Architektur und soziale Präsenz im zukünftigen Nachtleben.\n\nSeine Silhouetten konstruieren wechselnde Räume um den Körper und prägen Bewegung, Distanz und Sichtbarkeit."],
      [".archive-footer a", "Next: Magnetic Tape →", "Weiter: Magnetic Tape →"]
    ],
    "magnetic-tape.html": [
      [".collection-intro p", "Magnetic Tape examines memory embedded in matter.\n\nAnalogue recording media, obsolete technologies and past images of the future become physical structures worn around the body.", "Magnetic Tape untersucht die in Materie eingebettete Erinnerung.\n\nAnaloge Aufzeichnungsmedien, veraltete Technologien und vergangene Bilder der Zukunft werden zu physischen Strukturen, die um den Körper getragen werden."],
      [".archive-footer a", "Next: DNA Mutation →", "Weiter: DNA Mutation →"]
    ],
    "dna-mutation.html": [
      [".collection-intro p", "DNA Mutation explores biological adaptation as a form of dress.\n\nClothing, anatomy and genetic transformation converge until mutation itself functions as the garment.", "DNA Mutation erforscht biologische Anpassung als eine Form der Kleidung.\n\nKleidung, Anatomie und genetische Transformation verschmelzen, bis die Mutation selbst als Kleidungsstück fungiert."],
