(function () {
  ...
  const home = [
    ...
    ["#artists .artists-intro-copy", "A constellation of artists shaping the Parallel Vision archive.", "Eine Konstellation von Künstler:innen, die das Archiv von Parallel Vision prägt."],
