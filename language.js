(function () {
  ...
  const home = [
    ...
    ["#artists #artists-title", "Artists", "Künstler:innen"],
    ["#artists .artists-intro-copy", "A growing roster of artists shaping the sound and visual language of Parallel Vision.", "Ein wachsendes Künstler:innen-Roster, das die klangliche und visuelle Sprache von Parallel Vision prägt."],
    ["#artists .artist-roster-alejandro .artist-roster-location", "Berlin", "Berlin"],
    ["#artists .artist-roster-alejandro .artist-roster-description", "Founder, producer and live performer.", "Gründer, Produzent und Live-Performer."],
    ["#artists .artist-roster-refrakt .artist-roster-location", "New York", "New York"],
    ["#artists .artist-roster-refrakt .artist-roster-description", "Cinematic club pressure and tension.", "Filmischer Clubdruck und Spannung."],
    ["#artists .artist-roster-refrakt .artist-roster-action", "View artist", "Artist ansehen"],
    ["#artists .artist-roster-elorian .artist-roster-location", "Mexico City", "Mexiko-Stadt"],
    ["#artists .artist-roster-elorian .artist-roster-description", "Hypnotic electronic movement and atmosphere.", "Hypnotische elektronische Bewegung und Atmosphäre."],
    ["#artists .artist-roster-cabizbajo .artist-roster-description", "Dark rhythmic electronics.", "Dunkle rhythmische Elektronik."],
    ["#artists .artist-roster-octave .artist-roster-description", "Atmospheric club dynamics.", "Atmosphärische Clubdynamik."],
    ["#artists .artist-roster-blex .artist-roster-description", "Ritual indie dance.", "Ritueller Indie Dance."],
    ["#artists .artist-roster-badwolf .artist-roster-description", "Shadowed dancefloor energy.", "Dunkle Dancefloor-Energie."],
